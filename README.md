...
- [2. 工作需求——C++，算法等](#2-工作需求c算法等)
  - [2.1 程序编译链接/计算机内存](#21-程序编译链接计算机内存)
...
+ *92.* 线性代数(理工类)第五版 (吴赣昌) ，来自[Z-Library](https://zh.zlibrary-asia.se/book/21067682/812f36?dsource=recommend)
+ *93.* 线性代数（第五版） (蔡光兴, 李逢高) ，来自[Z-Library](https://zh.zlibrary-asia.se/book/24231920/ba98f5/%E7%BA%BF%E6%80%A7%E4%BB%A3%E6%95%B0%E7%AC%AC%E4%BA%94%E7%89%88.html?dsource=recommend)
...
## 2.1 程序编译链接/计算机内存
+ *24.* 程序员的自我修养--链接、装载与库
+ *100.* cpumemory(what every programmer should know about memory), [链接](https://people.freebsd.org/~lstewart/articles/cpumemory.pdf)
  + *100.* Programmer_Memory_BLU_July2023, 这是个ppt，基于上面那个总结的
